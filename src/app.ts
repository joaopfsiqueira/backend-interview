...
import { IController } from './interfaces/controller.interface'; //taking everything that is implemented inside the IController, which is the interface that is implemented in each controller class
